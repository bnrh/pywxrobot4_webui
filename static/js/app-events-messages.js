...
export function registerMessagesEvents(actions) {
    ...
    bindOnce(elements.refreshMessagesButton, "messages.refresh", "click", async () => {
        try {
    ...
    bindOnce(elements.messageList, "messages.listClick", "click", (event) => {
    ...
    bindOnce(elements.messageDetail, "messages.detailClick", "click", async (event) => {
